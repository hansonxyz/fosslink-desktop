...
export const en: Record<string, string> = {
  ...
  'extras.backupTitle': 'Backup / Export All',
  'extras.backupSubtitle': 'Save threads, gallery or full phone storage',

  // Backup / Export
  'backup.title': 'Backup / Export All',
  'backup.intro': 'Save a backup of all your message threads to a folder on this computer. Optionally export the phone’s gallery, screenshots, all images, or the entire phone storage.',
  'backup.chooseOne': 'Choose one to export:',
  'backup.threadsLabel': 'Export threads as…',
  'backup.threadsFormatTxt': 'Text files (one per thread)',
  'backup.threadsFormatXml': 'XML (single file)',
  'backup.threadsFormatHtml': 'Interactive HTML document',
  'backup.threadsIncludeMedia': 'Include MMS images and video',
  'backup.galleryLabel': 'Export Gallery',
  'backup.galleryDesc': 'Photos and videos from the phone’s DCIM folder (camera captures)',
  'backup.screenshotsLabel': 'Export Screenshots',
  'backup.screenshotsDesc': 'Only the Screenshots folder',
  'backup.imagesLabel': 'Export all Images',
  'backup.imagesDesc': 'Every image on the phone, from all folders',
  'backup.foldersLabel': 'Export all media by folder',
  'backup.foldersDesc': 'Every photo and video from every folder, preserving the phone’s folder structure',
  'backup.exportAsBtn': 'Export As…',
  'backup.groupThreads': 'Text Message Backup',
  'backup.groupMedia': 'Photo Gallery Backup',
  'backup.overwriteTitle': 'Folder is not empty',
  'backup.overwriteBody': '{path} already contains files. Existing files with the same names will be overwritten. Continue?',
  'backup.cancelBtn': 'Cancel',
  'backup.continueBtn': 'Continue',
  'backup.cancelExportBtn': 'Cancel export',
  'backup.preparing': 'Preparing…',
  'backup.doneTitle': 'Export complete',
  'backup.doneSummary': 'Wrote {threads} threads, {messages} messages, {attachments} attachments in {seconds}s.',
  'backup.doneMediaSummary': 'Wrote {written} file(s) ({size}), skipped {skipped} already present, in {seconds}s.',
  'backup.doneWithErrors': '{count} error(s) occurred — see daemon log for details.',
  'backup.doneEmpty': 'No files were written.',
  'backup.closeBtn': 'Close',
  'backup.errorTitle': 'Export failed',
